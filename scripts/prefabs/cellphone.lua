local assets = {
    Asset("ANIM", "anim/cellphone.zip"),
    Asset("ANIM", "anim/swap_cellphone.zip"),
    Asset("ATLAS", "images/inventoryimages/cellphone.xml")
}
...
local function OnEquip(inst, owner)
    owner.AnimState:OverrideSymbol("swap_object", "swap_cellphone", "item")
...
local function fn(Sim)
    ...
    anim:SetBank("cellphone")
    anim:SetBuild("cellphone")
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/cellphone.xml"
    return inst
end

-- Custom item name
STRINGS.NAMES.CELLPHONE = "Smartphone"
-- Generic description of an item
STRINGS.CHARACTERS.GENERIC.DESCRIBE.CELLPHONE = "Better watch out!"

return Prefab("common/inventory/cellphone", fn, assets)
